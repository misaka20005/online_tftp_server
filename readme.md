...
- 编译并运行服务端
  > src/run.sh 
- 运行客户端
  > clients/client/run2.sh
- 运行客户端1
  > clients/client1/run2.sh

#### 演示地址
- [演示视频](【基于 linux c的网络文件传输服务器介绍】 https://www.bilibili.com/video/BV1xNDxBkErM/?share_source=copy_web&vd_source=b86277b489a62ad033db2e3d038121c9)
